...
**Approved by the TSC on 2026-07-13.**

The TSC adopted **Option B** from [Open decision: default values](#open-decision-default-values): in addition to bare `${VAR_NAME}` references, the POSIX `${VAR_NAME:-default}` form is adopted.
...
- [RFC-0001: Servers](../odcs-v3.0.0/0001-servers.md) — establishes the `servers` section
