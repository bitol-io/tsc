...
| **HCL**         | [HCL Informix Vector Blade](https://www.hcl-software.com/informix)                                                                                                                      | `lvector_embedding (N)`                                         | 2–1536 ¹   | `float` (float64)                                            | cosine                                        |
...
| Date | Author | Change |
| ---- | ------ | ------ |
| 2026-05-28 | Jean-Georges Perrin | Added HCL Informix Vector Blade to the physical type mapping and vendor landscape (`lvector_embedding (1536)`, 2–1536 dims at first release, float64, cosine). |
