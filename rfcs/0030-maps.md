  ...
  - name: users
    properties:
      - name: user_preferences
        ...
        mapKeys:  ## Naming: keys, mapKeys, mapKeyType, keysDefinition ...
          logicalType: string
  ...
  - name: users
    properties:
      - name: user_preferences
        ...
        description: "User preference key-value pairs"
        entries:
          keys:  ## Naming: keys, mapKeys, mapKeyType, keysDefinition ...
            logicalType: string
            description: "Preference name"
          values: ## Naming
            logicalType: string
...
Adds a new type `map` to the enum, which is a larger schema change. 
Maps are conceptually a variant of `object` (with dynamic rather than static keys), so extending `object` could be more natural.
But what about physical types in this scenario?
